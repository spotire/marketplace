    ...
    'ko',
        ...
        return Component.extend({
            ...
            _showProductNotification: function (productData) {
                $('#menu-webkul-marketplace-marketplace .item-product').css('position','relative');
                var data = {},
                    notifyTmp;
                ...
                $(notifyTmp)
                .appendTo($('#menu-webkul-marketplace-marketplace .item-product'));
            },
            _showSellerNotification: function (sellerData) {
             ...
             _showFeedbackNotification: function (feedbackData) {
                $('#menu-webkul-marketplace-marketplace .item-feedback').css('position','relative');
                var data = {},
                    notifyTmp;
                ...
                $(notifyTmp)
                .appendTo($('#menu-webkul-marketplace-marketplace .item-feedback'));
            },
